...
public class Server {
    ...
    private static void setSystemProperties() {
        System.setProperty("javax.net.ssl.keyStore", applicationProperties.getFileFromConfig(applicationProperties.getProperty("keyStore")).getPath());
    ...
    private static void processFilesInDirectory(String folderName, DatabaseConnection databaseConnection) {
        File resourceDir = applicationProperties.getFileFromConfig("database/" + folderName);
